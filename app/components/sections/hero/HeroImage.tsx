...
function HeroImage({ srcBody, srcHead }: HeroIMageProps) {
  return (
    <section className="order-1 overflow-x-hidden md:overflow-visible overflow-y-clip -mb-[5vw] md:mb-[0] pl-[8vw] md:pl-[0] mr-[7.25vw] md:order-2 col-start-1 col-end-5 md:col-start-6 md:col-end-9  lg:col-start-8  lg:col-end-13 items-center  flex pt-[4vw]">
