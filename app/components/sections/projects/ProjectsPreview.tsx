    ...
    <>
      ...
      <section className=" max-w-full pt-24 pb-10  md:pt-36   w-screen flex flex-col justify-center content-center items-center">
        <TailwindGrid >
          <div className=" self-center  col-start-1 lg:col-start-2 col-end-5 md:col-end-9 lg:col-end-13 w-full  flex flex-col">
            ...
            <SecondaryButton className={'text-center hidden md:block hover:bg-white hover:text-zinc-950 text-[2.8vw] md:text-[min(2vw,22px)] mt-[3vw]   font-bold uppercase self-center px-[2vw] py-[0.5vw] border border-white  rounded-full'}>
            check more project
          </SecondaryButton>
          </div>
        </TailwindGrid>
      ...
      <TailwindGrid >
        <div className="w-full col-start-1 col-end-5 md:hidden  justify-center items-center flex mt-[13.5vw]   sm:mt-[8.5vw]">
          ...
          <SecondaryButton className={'text-center hover:bg-white hover:text-zinc-950  text-[min(3vw,22px)]  font-bold uppercase self-center px-[4vw] py-[1.5vw] border border-white  rounded-full'}>
            check more project
          </SecondaryButton>
        </div>
      </TailwindGrid>
