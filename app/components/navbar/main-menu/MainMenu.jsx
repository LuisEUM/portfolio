      ...
      <AnimatePresence>
        {isOpen && (
          <>
            <div>
              ...
              >
                <svg
                  ...
                  className="flex self-center items-center justify-center col-span-1 fill-zinc-300 col-start-2"
                >
              ...
              >
                <svg
                  ...
                  viewBox="0 0 16 17"
                  xmlns="http://www.w3.org/2000/svg"
                  className="flex items-center self-center justify-center col-span-1 fill-zinc-300 col-start-2"
                >
            ...
            <div
              className="grid grid-cols-12  py-5 px-5 w-full absolute bottom-28"
              onClick={toggleOpen}
            >
              <ContactButton
                setModalOpenNavbar={setModalOpenNavbar}
                className="w-full col-start-2 bg-primary col-span-10 uppercase text-zinc-900 tracking-wider font-extrabold text-lg rounded-lg py-3"
              />
            </div>
          </>
        )}
