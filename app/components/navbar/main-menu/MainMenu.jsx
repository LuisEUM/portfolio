            ...
            <div>
              ...
              >
                <svg
                  ...
                  className="flex self-center items-center justify-center col-span-1 fill-zinc-300 col-start-1 lg:col-start-2"
                >
              ...
              >
                <svg
                  ...
                  viewBox="0 0 16 17"
                  xmlns="http://www.w3.org/2000/svg"
                  className="flex items-center self-center justify-center col-span-1 fill-zinc-300 col-start-1 lg:col-start-2"
                >
