...
const MainMenu = ({ isOpen, toggleOpen, setModalOpenNavbar }) => {
  ...
  return (
    <motion.ul
      ...
      exit="closed"
      className="flex-row group-first:border-b-2 top-[75px] right-0 fixed min-w-[300px] w-7/12  h-full  items-center px-[5%] "
      ref={ref}
    >
      <AnimatePresence>
        {isOpen && (
            ...
            <div>
              {routes.map((route) => (
                <Link
                  ...
                  className={` w-full   relative items-center px-4   flex  tracking-wider rounded-md   ${
                ...
                >
                  <motion.div
                    className="justify-center grid grid-cols-12  hover:bg-zinc-800 py-5 "
                    whileTap={{ scale: 0.9 }}
                  >
                    <Image
                      src={route.icon}
                      ...
                      className=" fill-zinc-300 w-full h-full col-span-1  "
                    />
              ...
              <div className="grid grid-cols-12 py-5 px-5">
                <div className="grid col-span-12 grid-cols-12 relative">
                  <Image
                    priority
                    ...
                    sizes="fill"
                    alt="Follow us on Twitter"
                    className="flex w-full h-full self-center items-center justify-center col-span-1 fill-zinc-300 col-start-1 lg:col-start-2"
                  />
