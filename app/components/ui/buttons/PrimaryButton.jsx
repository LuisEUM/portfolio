...
function PrimaryButton ({ text }) {
  return (
    <motion.button
      ...
      className="group  self-stretch cursor-pointer justify-center items-center inline-flex lg:min-w-[172px] w-full lg:w-[13vw]  rounded-md border border-primary text-primary hover:text-zinc-950 bg-zinc-950/40 backdrop-blur-lg bg-clip-padding backdrop-filter hover:bg-primary  h-12 gap-2 pl-4 pr-2.5"
    >
      <div className="justify-center items-center gap-4 flex">
        ...
        <p className=" text-center text-[min(1rem,,3.16vw)]  -zinc-950 lg:text-[1vw] font-bold uppercase mx-auto">
          DESCARGAR CV
        </p>
      </div>
    </motion.button>
