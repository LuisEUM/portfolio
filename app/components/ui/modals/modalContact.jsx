  ...
  return (
      <Backdrop onClick={handleClose}>
          ...
          >
            <ModalContent/>
            <motion.button
              className="border border-zinc-700 rounded w-52 bg-zinc-700 text-zinc-100 font-medium mb-5"
              onClick={handleClose}
      ...
      <div className="w-full rounded-xl">
        ...
        >
          <div className="flex items-center justify-center">
            <p className="text-xl font-bold text-gray-800">You are really close to one of the best decisions of your life 😎</p>
          </div>
        </div>

        {/* <!--MODAL BODY--> */}
        <div className="my-4">
          <p className="text-sm">Check my profile on others platforms:</p>
          ...
          <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
            ...
            <input className="w-full outline-none bg-transparent" type="text" placeholder="link" value="luiseum95@gmail.com"/>
