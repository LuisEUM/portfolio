...
export default function WordsChangers({ words, alternative, setSafeRemove}) {
    ...
    <>
      ...
      >
        <motion.strong
          ...
          onAnimationComplete={() => { setTimeout(()=>{setSafeRemove(true)}, 1000) }}
        >
          {alternative ? <WordsAnimation text={currentWord} /> : <LettersAnimation text={currentWord} /> }
        </motion.strong>
